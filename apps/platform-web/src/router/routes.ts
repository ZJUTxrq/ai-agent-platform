...
const workspaceChildren: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    name: 'workspace-requirement-review',
    component: () => import('@/modules/requirement-review/pages/RequirementReviewPage.vue'),
    meta: {
      title: '需求评审',
  ...
  {
    path: 'requirement-review-documents',
    name: 'workspace-requirement-review-documents',
    component: () => import('@/modules/requirement-review/pages/RequirementReviewDocumentsPage.vue'),
    meta: {
      title: '文档列表',
      eyebrow: 'Requirement Review',
      requiredPermissions: ['project.runtime.read'],
