...
export type RequirementReviewOverview = {
  project_id: string
  documents_total: number
  parsed_documents_total: number
  failed_documents_total: number
  results_total: number
  pass_results_total: number
  conditional_results_total: number
  fail_results_total: number
  latest_batch_id?: string | null
  latest_activity_at?: string | null
}

export type RequirementReviewBatchSummary = {
  batch_id: string
  documents_count: number
  results_count: number
  latest_created_at?: string | null
  parse_status_summary: Record<string, number>
  quality_gate_summary: Record<string, number>
}

export type RequirementReviewDocument = {
  id: string
  project_id: string
  batch_id?: string | null
...
export type RequirementReviewResult = {
  ...
  key_findings: string[]
  major_risks: string[]
  missing_or_ambiguous_items: string[]
...
export type RequirementReviewRole = {
  project_id: string
  role: ProjectRole
