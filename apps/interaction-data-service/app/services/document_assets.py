...
def build_document_asset_relative_path(
    *,
    namespace: str = "test-case-service",
    project_id: str,
    batch_id: str | None,
    asset_key: str,
    filename: str | None,
    ...
    namespace_segment = _safe_segment(namespace, fallback="documents")
    ...
    return f"{namespace_segment}/{project_segment}/{batch_segment}/{key_segment}{extension}"
