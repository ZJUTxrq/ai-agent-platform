...
from app.modules.requirement_review.application import RequirementReviewService
...
def _build_requirement_review_service(
    *,
    settings: Settings,
    session_factory: sessionmaker[Session] | None,
...
def build_operation_worker(
    *,
    ...
    requirement_review_service = _build_requirement_review_service(
        settings=settings,
        session_factory=session_factory,
    )
    ...
    registry = OperationExecutorRegistry(
        (
            ...
            RequirementReviewDocumentsExportExecutor(
                service=requirement_review_service,
                artifact_store=artifact_store,
            ),
            RequirementReviewResultsExportExecutor(
                service=requirement_review_service,
