...
test_case_schemas_v2 = importlib.import_module(
    "runtime_service.services.test_case_service_v2.schemas"
)
...
def test_test_case_v2_skills_are_enumerable() -> None:
    backend = FilesystemBackend(
        root_dir=str(test_case_schemas_v2.get_service_root()),
        virtual_mode=True,
    )
    ...
    assert _EXPECTED_SKILLS <= skill_names
